...
!mkdir "abcabc"
!unzip "/content/U20.zip" -d abcabc
###########################3FEATURE EXTRACTION TRAINING SET###########################################333
# MAXIMUM CALCULATION
maximum = 0
file1 = open(r"/content/abcabc/U20/TRAIN/U20S1.TXT", 'r')
datapath = r"/content/abcabc/U20"
...
###################################### FEATURE EXTRACTION TRAINING SET--------PHYSICAL FEATURES#######################
data_set = []
file1 = open(r"/content/abcabc/U20/TRAIN/U20S1.TXT", 'r')
ind = []
List_coor = []
y = []
no_of_img = 0
datapath = r"/content/abcabc/U20/TRAIN"
data = os.listdir(datapath)
for dataset in data:
    print(dataset)
    List_coor_target = []
        ...
        if(k == 1):
          for i in range(len(line)):
              ...
              if(d == 3 and lead5 == 0):
                  ...
                  lead5 = 1
          time = time+1
          code_t = line[temp2:temp6]
          code_t = int(code_t)
          code_y = line[temp:temp2]
          code = line[0:temp]
          code_azi = line[temp3:temp4]
          code_alt = line[temp4:temp5]
          ...
          List_coor_target_t.append(code_t)
...
y = []
no_of_img = 0
datapath = r"/content/abcabc/U20/TEST"
data = os.listdir(datapath)
for dataset in data:
    print(dataset)
    List_coor_target = []
